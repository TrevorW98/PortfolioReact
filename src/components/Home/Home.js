            ...
            <>
                ...
                <Container id="AboutMe" fluid>
                    ...
                    <Row style={{ display: 'flex', justifyContent: 'center' }}>
                        ...
                        <Col sm={5} className="d-none d-lg-block" style={{ marginBottom: '160px' }} >
                        ...
                        <Col sm={10} className="d-block d-lg-none" >
                ...
                <Container id="Education" fluid >
                    ...
                    <Row style={{ display: 'flex', justifyContent: 'center' }}>
                        <Col  xs={10} sm={8} style={{ display: 'flex', justifyContent: 'center', marginBottom: '25px' }}>
                            <Image className="d-block d-lg-none" style={{ borderRadius: '50px', boxShadow: '8px 8px 10px' }} fluid src={CertXS} ></Image>
                        </Col>
                ...
                <Container fluid id="Skills">
                    ...
                    <Row className="d-none d-lg-block">
                        <Col style={{ display: 'flex', justifyContent: 'center', marginTop: '40px' }}>
                            <ReactCardFlip isFlipped={this.state.isFlipped} flipDirection="horizontal">
                                <Card style={{ width: '60rem', height: '32rem', border: 'none', borderRadius: "13px", boxShadow: '5px 5px 8px #18181d', backgroundColor: '#18181d' }}>
                    ...
                    <Row className="d-none d-md-block d-lg-none">
                        <Col style={{ display: 'flex', justifyContent: 'center', marginTop: '10px' }}>
                            <ReactCardFlip isFlipped={this.state.isFlipped} flipDirection="horizontal">
                                <Card style={{ width: '30rem', height: '23rem', border: 'none', borderRadius: "13px", boxShadow: '5px 5px 8px #18181d', backgroundColor: '#18181d' }}>
                                    <Card.Header style={{ color: 'white', fontFamily: 'InterBold', fontSize: '20px', textAlign: 'center' }}>Front-End</Card.Header>
                                    <Card.Body>
                                        <Card.Title style={{ color: 'white', fontFamily: 'InterMed', fontSize: '16px', textAlign: 'center' }}>Languages, Frameworks, and Libraries</Card.Title>
                                        <Image className="growLarger" style={{ width: '50px', padding: '3px' }} src={HTML} alt="The HTML 5 logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '3px' }} src={CSS} alt="The CSS Logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '3px' }} src={JS} alt="The Javascript logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '3px' }} src={TS} alt="The TypeScript Logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '3px' }} src={IONIC} alt="The Ionic logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px' }} src={REACT} alt="The React logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '3px' }} src={BOOT} alt="The Bootstrap logo"></Image>
                                        <Image className="growLarger" style={{ width: '57px' }} src={ANGULAR} alt="The Angular logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px' }} src={Native} alt="The React Native logo"></Image>
                                    </Card.Body>
                                    <Card.Body>
                                        <Card.Title style={{ color: 'white', fontFamily: 'InterMed', fontSize: '16px', textAlign: 'center' }}>Services</Card.Title>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={XD} alt="The AdobeXD Logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={WINDOW} alt="The AdobeXD Logo"></Image>
                                        <Image className="growLarger" style={{ width: '70px', padding: '5px' }} src={UNITY} alt="The Unity logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={VSCode} alt="The VS Code logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={JIRA} alt="The Jira logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={Github} alt="The GitHub logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={Slack} alt="The Slack logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={Notion} alt="The Notion logo"></Image>
                                    </Card.Body>
                                    <div style={{ display: 'flex', justifyContent: 'center' }}>
                                        <Button style={{ width: '90px', textAlign: 'center', backgroundColor: '#ffffff', color: '#000000', fontFamily: 'InterMed', fontSize: '12px' }} onClick={this.handleClick} variant="primary">Back-End</Button>
                                    </div>
                                </Card>

                                <Card style={{ width: '30rem', height: '23rem', border: 'none', borderRadius: "13px", boxShadow: '5px 5px 8px #18181d', backgroundColor: '#18181d' }}>
                                    <Card.Header style={{ color: 'white', fontFamily: 'InterBold', fontSize: '20px', textAlign: 'center' }}>Back-End</Card.Header>
                                    <Card.Body>
                                        <Card.Title style={{ color: 'white', fontFamily: 'InterMed', fontSize: '16px', textAlign: 'left' }}>Languages, Frameworks, and Libraries</Card.Title>
                                        <Image className="growLarger" style={{ width: '50px' }} src={CSHARP} alt="The C Sharp Logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px' }} src={NET} alt="The dot net core Logo"></Image>
                                    </Card.Body>
                                    <Card.Body>
                                        <Card.Title style={{ color: 'white', fontFamily: 'InterMed', fontSize: '16px', textAlign: 'left' }}>Services</Card.Title>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={SQL} alt="The SQL server logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={FileZilla} alt="The FileZilla logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={Postman} alt="The Post Man logo"></Image>
                                        <Image className="growLarger" style={{ width: '50px', padding: '5px' }} src={AZURE} alt="The Azure logo"></Image>
                                    </Card.Body>
                                    <div style={{ display: 'flex', justifyContent: 'center' }}>
                                        <Button style={{ width: '110px', textAlign: 'center', backgroundColor: '#ffffff', color: '#000000', fontFamily: 'InterMed' }} onClick={this.handleClick} variant="primary">Front-End</Button>
                                    </div>
                    ...
                    <Row className="d-block d-md-none ">
                        <Col style={{ display: 'flex', justifyContent: 'center', marginTop: '10px' }}>
                            <ReactCardFlip isFlipped={this.state.isFlipped} flipDirection="horizontal">
                                <Card style={{ width: '18rem', height: '25rem', border: 'none', borderRadius: "13px", boxShadow: '5px 5px 8px #18181d', backgroundColor: '#18181d' }}>
                                    <Card.Header style={{ color: 'white', fontFamily: 'InterBold', fontSize: '18px', textAlign: 'center' }}>Front-End</Card.Header>
                                    <Card.Body>
                                        <Card.Title style={{ color: 'white', fontFamily: 'InterMed', fontSize: '14px', textAlign: 'center' }}>Languages, Frameworks, and Libraries</Card.Title>
                                        <Image className="growLarger" style={{ width: '40px', padding: '3px' }} src={HTML} alt="The HTML 5 logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '3px' }} src={CSS} alt="The CSS Logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '3px' }} src={JS} alt="The Javascript logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '3px' }} src={TS} alt="The TypeScript Logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '3px' }} src={IONIC} alt="The Ionic logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px' }} src={REACT} alt="The React logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '3px' }} src={BOOT} alt="The Bootstrap logo"></Image>
                                        <Image className="growLarger" style={{ width: '47px' }} src={ANGULAR} alt="The Angular logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px' }} src={Native} alt="The React Native logo"></Image>
                                    </Card.Body>
                                    <Card.Body>
                                        <Card.Title style={{ color: 'white', fontFamily: 'InterMed', fontSize: '14px', textAlign: 'center' }}>Services</Card.Title>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={XD} alt="The AdobeXD Logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={WINDOW} alt="The AdobeXD Logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={UNITY} alt="The Unity logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={VSCode} alt="The VS Code logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={JIRA} alt="The Jira logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={Github} alt="The GitHub logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={Slack} alt="The Slack logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={Notion} alt="The Notion logo"></Image>
                                    </Card.Body>
                                    <div style={{ display: 'flex', justifyContent: 'center' }}>
                                        <Button style={{ width: '90px', textAlign: 'center', backgroundColor: '#ffffff', color: '#000000', fontFamily: 'InterMed', fontSize: '12px' }} onClick={this.handleClick} variant="primary">Back-End</Button>
                                    </div>
                                ...
                                <Card style={{ width: '18rem',height: '25rem', border: 'none', borderRadius: "13px", boxShadow: '5px 5px 8px #18181d', backgroundColor: '#18181d' }}>
                                    <Card.Header style={{ color: 'white', fontFamily: 'InterBold', fontSize: '18px', textAlign: 'center' }}>Back-End</Card.Header>
                                    <Card.Body>
                                        <Card.Title style={{ color: 'white', fontFamily: 'InterMed', fontSize: '14px', textAlign: 'left' }}>Languages, Frameworks, and Libraries</Card.Title>
                                        <Image className="growLarger" style={{ width: '40px' }} src={CSHARP} alt="The C Sharp Logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px' }} src={NET} alt="The dot net core Logo"></Image>
                                    </Card.Body>
                                    <Card.Body>
                                        <Card.Title style={{ color: 'white', fontFamily: 'InterMed', fontSize: '14px', textAlign: 'left' }}>Services</Card.Title>
                                        <Image className="growLarger" style={{ width: '30px', padding: '5px' }} src={SQL} alt="The SQL server logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={FileZilla} alt="The FileZilla logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={Postman} alt="The Post Man logo"></Image>
                                        <Image className="growLarger" style={{ width: '40px', padding: '5px' }} src={AZURE} alt="The Azure logo"></Image>
                                    </Card.Body>
                                    <div style={{ display: 'flex', justifyContent: 'center' }}>
                                        <Button style={{ width: '110px', textAlign: 'center', backgroundColor: '#ffffff', color: '#000000', fontFamily: 'InterMed', fontSize: '12px' }} onClick={this.handleClick} variant="primary">Front-End</Button>
                                    </div>
                                </Card>
                            </ReactCardFlip>
                        </Col>
                ...
                <Container fluid >
                    ...
                    <Row style={{ display: 'flex', justifyContent: 'center' }}>
                        ...
                        {/* Small */}
                        <Col className="d-block d-md-none" style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
                            <a style={{ textDecoration: 'none', border: 'none' }} target="_blank" rel="noreferrer" href="http://play.google.com/store/apps/details?id=io.ionic.TritonFull">
                                <Tilt tiltEnable={false} tiltReverse={true} style={{ display: 'flex', justifyContent: 'center' }}>
                                    <Card style={{ width: '15rem', height: '25rem', border: 'none', borderRadius: "13px", boxShadow: '5px 5px 8px #18181d', backgroundColor: '#18181d' }}>
                                        <Card.Img style={{ borderRadius: '12px 12px 0px 0px' }} variant="top" src={Triton} alt="The logo for Triton, a paw print on a square, teal background" />
                                        <Card.Body>
                                            ...
                                            <Card.Text style={{ color: 'white', fontFamily: 'InterReg', fontSize: '10px', textAlign: 'center' }}>
                                                A full-stack mobile application which gives users access to an index of animals, the information needed to care for them, and other pet-care focused features.
                                            </Card.Text>
                                            <div style={{ marginTop: '5px', padding: '0px', display: 'flex', justifyContent: 'center' }}>
                                                <span className="badge bg-danger" style={{ color: 'white', marginRight: '5px', fontSize: '8px' }}>Angular 11</span>
                                                <span className="badge" style={{ backgroundColor: '#1e7c34', color: 'white', marginRight: '5px', fontSize: '8px' }}>Android SDK</span>
                                                <span className="badge" style={{ backgroundColor: '#004fa3', color: 'white', marginRight: '5px', fontSize: '8px' }}>SQL Server</span>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                </Tilt>
